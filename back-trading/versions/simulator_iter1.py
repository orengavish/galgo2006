...
def simulate_exit(fill_price: float,
                  ...
                  stag_move: float | None = None) -> dict:
    """
    ...
    first tick at time >= fill_time+stag_seconds where abs(price-fill)<stag_move.
    ...
    # Stagnation: first tick at/after fill+stag_seconds within stag_move of fill
    stag_hit = None
